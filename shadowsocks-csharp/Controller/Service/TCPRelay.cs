    ...
    internal class TCPHandler
    {
        ...
        private void StartConnect()
        {
            try
            {
				...
				// if not using proxy, or using plugin, proxyEP is null, that is ok, since it's not really used (in DirectProxy),
				// anything go directly to the server
				// if plugin, serverip = plugin, data flow thru plugin to server.
