...
namespace test
{
    ...
    public class UnitTest
    {
		...
		public void Zipfile()
		{
			...
			f1 = @"..\..\..\shadowsocks-csharp\Data\x64\libsscrypto.dll";
			f2 = @"..\..\..\shadowsocks-csharp\Data\libsscrypto64.dll.gz";
			CompressFile(f1, f2);
		}

		public static void CompressFile(string srcfile, string fileName)
		{
			...
			using (GZipStream output = new GZipStream(destinationFile, CompressionMode.Compress, false))
			{
				src.CopyTo(output);
			}
			src.Close();
